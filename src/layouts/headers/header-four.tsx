...
import logo_1 from '@/assets/img/home-04/logo.webp';
import logo_2 from '@/assets/img/home-04/logo.webp';
              ...
              <div className="col-xl-3 col-lg-6 col-md-6 col-6">
                <div className="tp-header-logo tp-header-3-logo">
                  <Link className="logo-1" href="/">
                    <Image src={logo_1} alt="logo" style={{ width: "280px", height: "auto" }} />
                  </Link>
                  <Link className="logo-2" href="/">
                    <Image src={logo_2} alt="logo" style={{ width: "280px", height: "auto" }} />
                  </Link>
                </div>
              </div>
                ...
                <div className="tp-header-3-menu-wrap text-center">
                  <div className="tp-header-3-menu-box d-inline-flex align-items-center justify-content-between">
                    ...
                    <div className="tp-header-3-cart p-relative">
                      <button className="cartmini-open-btn" onClick={() => setOpenCartMini(false)}>
                        <span>
                          <Cart clr="white" />
                        </span>
                        <em>0</em>
